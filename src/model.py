...
def train_model(
    ...
    oversample = RandomOverSampler(
        sampling_strategy=sample_strat, random_state=rand_state
    )
    ...
    X_train, X_test, y_train, y_test = sklearn.model_selection.train_test_split(
        X_over, y_over, test_size=ts, random_state=rand_state
    )
    ...
    rf = sklearn.ensemble.RandomForestClassifier(
        n_estimators=n_estimat, max_depth=max_dep, random_state=rand_state
    )
