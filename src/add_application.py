...
class Application(Base):
    ...
    CODE_GENDER = sqlalchemy.Column(
        sqlalchemy.String(100), unique=False, nullable=False
    )
    FLAG_OWN_CAR = sqlalchemy.Column(
        sqlalchemy.String(100), unique=False, nullable=False
    )
    FLAG_OWN_REALTY = sqlalchemy.Column(
        sqlalchemy.String(100), unique=False, nullable=True
    )
    ...
    NAME_INCOME_TYPE = sqlalchemy.Column(
        sqlalchemy.String(100), unique=False, nullable=True
    )
    NAME_EDUCATION_TYPE = sqlalchemy.Column(
        sqlalchemy.String(100), unique=False, nullable=True
    )
    NAME_FAMILY_STATUS = sqlalchemy.Column(
        sqlalchemy.String(100), unique=False, nullable=True
    )
    NAME_HOUSING_TYPE = sqlalchemy.Column(
        sqlalchemy.String(100), unique=False, nullable=True
    )
    ...
    FLAG_WORK_PHONE = sqlalchemy.Column(
        sqlalchemy.String(100), unique=False, nullable=True
    )
    ...
    OCCUPATION_TYPE = sqlalchemy.Column(
        sqlalchemy.String(100), unique=False, nullable=True
    )
...
class ApplicationManager:
    ...
    def add_application_df(self, input_path: str) -> None:
        ...
        try:
            ...
            my_message = (
                "You might have connection error. Have you configured \n"
            ...
            my_message = (
                "Have you already inserted the same record into the database before? \n"
